// Source: https://github.com/Spu7Nix/SPWN-language/blob/master/levelstring/src/lib.rs
...
fn decrypt_savefile(sf: Vec<u8>) -> Result<Vec<u8>, String> {
    if cfg!(target_os = "macos") {
        Err("No mac support".to_string())
    } else {
